...
public class SyntacticFeaturizerTester<SYS extends MCSystem> {
	...
	public static void main(String[] args) {
		...
		int w = 5;
		int a = 0;
		SyntacticFeaturizer syntacticFeaturizer = new SyntacticFeaturizer();
		List<FeatureValue> features = syntacticFeaturizer.featurize(passage, w, question, a);
	}
