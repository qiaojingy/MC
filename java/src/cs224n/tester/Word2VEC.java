...
public class Word2VEC {
	...
	public static void main(String[] args) throws IOException {
		...
		vec.loadModel("/Users/david/Documents/Softwares/word2vec/GoogleNews-vectors-negative300.bin");
		//	 System.out.println(vec.distance("男人"));
		Set<WordEntry> c = vec.distance("apple");
		for (WordEntry w : c) {
	...
	public void loadModel(String path) throws IOException {
		...
		try {
			...
			for (int i = 0; i < words; i++) {
				word = readString(dis);
				if (i <2000) System.out.println(word);
